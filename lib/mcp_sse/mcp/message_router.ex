defmodule MCP.MessageRouter do
  ...
  @doc false
  def handle_message(assigns, %{"method" => "notifications/initialized"} = message) do
  ...
  def handle_message(assigns, %{"method" => method, "id" => id} = message) do
    ...
    case method do
      "ping" ->
        ...
        server_implementation.handle_ping(assigns, id)
      ...
      "initialize" ->
        ...
        server_implementation.handle_initialize(assigns, id, message["params"])
      ...
      "completion/complete" ->
        ...
        server_implementation.handle_complete(assigns, id, message["params"])

      "prompts/list" ->
        Logger.debug("Handling prompts list request")
        server_implementation.handle_list_prompts(assigns, id, message["params"])
      ...
      "prompts/get" ->
        ...
        server_implementation.handle_get_prompt(assigns, id, message["params"])

      "resources/list" ->
        Logger.debug("Handling resources list request")
        server_implementation.handle_list_resources(assigns, id, message["params"])
      ...
      "resources/read" ->
        ...
        server_implementation.handle_read_resource(assigns, id, message["params"])

      "tools/list" ->
        Logger.debug("Handling tools list request")
        server_implementation.handle_list_tools(assigns, id, message["params"])
      ...
      "tools/call" ->
        ...
        server_implementation.handle_call_tool(assigns, id, message["params"])
