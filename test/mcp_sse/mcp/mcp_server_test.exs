defmodule MCPServerTest do
  ...
  defmodule MockServer do
    ...
    @impl true
    def handle_complete(_assigns, request_id, params) do
      {:ok, %{request_id: request_id, type: "completion", completion: %{}}}
    end

    @impl true
    def handle_list_prompts(_assigns, request_id, params) do
    ...
    @impl true
    def handle_list_resources(_assigns, request_id, params) do
      {:ok, %{request_id: request_id, type: "list_resources", resources: []}}
    end

    @impl true
    def handle_read_resource(_assigns, request_id, params) do
      {:ok, %{request_id: request_id, type: "read_resource", contents: []}}
    end

    @impl true
    def handle_list_tools(_assigns, request_id, params) do
      {:ok, %{request_id: request_id, type: "list_tools", tools: []}}
    end

    @impl true
    def handle_call_tool(_assigns, request_id, params) do
